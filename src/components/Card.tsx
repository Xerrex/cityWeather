...
export function WeatherCard({ data }: { data: WeatherData }) {
  return (
    <div className="rounded-xl bg-gray-200 p-2 shadow-sm text-black">
      ...
      {data.type === "normal" && (
        <div className="flex rounded-xl bg-white px-2 py-8 justify-center">
          <span>
      ...
      {data.type === "sun" &&
        ...
        "sunrise" in data.value &&
        "sunset" in data.value && (

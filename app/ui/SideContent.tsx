  ...
  return (
    <div className="w-full flex flex-col p-2 items-center">
      ...
      <div className="p-2 flex flex-col">
        ...
        <div className="p-2 flex mt-2 content-center">
          <span className="text-lg text-black font-bold">Monday,</span>
          <span className="text-black">May 2025</span>
        ...
        <div className="mt-60 p-10 border-2 border-r-2 text-black"> Nairobi, Kenya</div>
